...
import { AppendOwnerStateReturnType } from '@mui/material/node_modules/@mui/base/utils/appendOwnerState';
import { MergeSlotPropsParameters, MergeSlotPropsResult, WithCommonProps } from '@mui/material/node_modules/@mui/base/utils/mergeSlotProps';
 ...
 */
export declare function useSlotProps<ElementType extends React.ElementType, SlotProps, AdditionalProps, OwnerState>(parameters: UseSlotPropsParameters<ElementType, SlotProps, object, WithCommonProps<Record<string, any>>, AdditionalProps, OwnerState>): import("@mui/material/node_modules/@mui/types").Simplify<import("@mui/material/node_modules/@mui/types").Simplify<SlotProps & object & AdditionalProps & {
